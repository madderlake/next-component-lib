...
export default {
  title: "VisualDiffs/Moments/Index/Default",
...
// Scenario: Index Section is required to have... (rdar://109897962)
export const Default: StoryFn<IndexSectionProps> = Template.bind({});
Default.args = args;
