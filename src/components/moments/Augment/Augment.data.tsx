      ...
      content: (
        <>
          <p>
            ...
            and fitness journey. Sensors in your AppleWatch combine with
            advanced algorithms to give you metrics that motivate you in your
            Apple Fitness+ workouts, and you can see that data synced to your
            iPad in realtime.
          </p>
          <ResponsivePicture
