    ...
    content: (
      <>
        <p>
          ...
          Control. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
    ...
    content: (
      <>
        <p>
          ...
          you can see that data synced to your iPad in realtime. Lorem ipsum
...
// Scenario: Accordion with two accordion items should accommodate a maximum amount of text content (rdar://108963462)
export const one1LineHeadlineOne2LineHeadline: StoryFn<ImageAccordionProps> =
  Template.bind({});
one1LineHeadlineOne2LineHeadline.args = {
  items: items2,
};

one1LineHeadlineOne2LineHeadline.storyName =
  "One 1-Line Headline, One 2-line Headline";
...
// Scenario: Accordion with three accordion items should accommodate a maximum amount of text content (rdar://115899748)
export const two1LineHeadlinesOne2LineHeadline: StoryFn<ImageAccordionProps> =
  Template.bind({});
two1LineHeadlinesOne2LineHeadline.args = {
  items: items5,
};

two1LineHeadlinesOne2LineHeadline.storyName =
  "Two 1-line Headlines, One 2-line Headline";

// Scenario: Accordion with three accordion items should accommodate a maximum amount of text content (rdar://115899748)
export const one1LineHeadlineTwo2LineHeadlines: StoryFn<ImageAccordionProps> =
  Template.bind({});
one1LineHeadlineTwo2LineHeadlines.args = {
  items: items6,
};

one1LineHeadlineTwo2LineHeadlines.storyName =
  "One 1-line Headline, Two 2-line Headlines";
